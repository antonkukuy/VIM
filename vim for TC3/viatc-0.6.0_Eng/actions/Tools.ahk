<Tools>:
	CustomActions ( " <ShowIPAddr> " , " displays the IP address " )
...
;Gui_Help()
{
	Gui,Destroy
	Gui,Font, s10
	Gui , Add , ListBox , W90 H400 X10 Y10 T2 gGui_ChangeTab, Global | hotkeys | Macros | plug | Help
	...
	Gui , Add , Tab2 , x110 y - 25   W480 H460 Buttons  AltSubmit , Global | hotkeys | Macros | plug | Help
	Gui,Tab,1
	Gui,Add,CheckBox
	Gui,Tab,2
...
Anchor(i, a = "", r = false) {
	...
	If z = 0
		Vrsetkpasiti (c, Gus *  ninety-nine , Change of Control ), Vrsetkpasiti (f, tightening * CX, Change of Control ), sh =  true
	If (!WinExist("ahk_id" . i)) {
		GuiControlGet, t, Hwnd, %i%
		If ErrorLevel = 0
			i := t
		Else  ControlGet in, hWnd,% of%
	}
