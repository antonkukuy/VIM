...
;RControl & WheelDown::AltTab
;Alt & WheelUp::ShiftAltTab
;AltTabAndMenu

; Auto-execute section {{{
GroupAdd VimGroup, ahk_class Notepad
GroupAdd VimGroup, ahk_class MindManager15WndClass
GroupAdd VimGroup, ahk_class WordPadClass
; GroupAdd VimGroup, ahk_class XLMAIN
GroupAdd VimGroup, ahk_class ClassicShell.CMenuContainer  ;win menu
...
GroupAdd VimGroup, ahk_class QTool ; laynchy
GroupAdd VimGroup, ahk_class DV2ControlHost ; Start
GroupAdd VimGroup, ahk_class Windows.UI.Core.CoreWindow ; Start win10
GroupAdd VimGroup, ahk_class AWL:2FD20000:8:0:5:0:0  ; Lingvo
GroupAdd VimGroup, ahk_class CabinetWClass ; Exploler
GroupAdd VimGroup, ahk_class SciTEWindow ; SciTE
GroupAdd VimGroup, ahk_class Notepad++
GroupAdd VimGroup, ahk_class RegEdit_RegEdit ; reg 
...
GroupAdd VimGroup, ahk_class #32770
GroupAdd VimGroup, ahk_class Afx:400000:0
;   If ahk_class ConsoleWindowClass ; cmd
;        suspend, on
;    Else
;        suspend, off
